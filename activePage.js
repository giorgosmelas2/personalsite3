  ...
  for (var i = 0; i < overlayListItems.length; i++) {
    overlayListItems[i].addEventListener("click", function() {
      ...
      if (this.getAttribute("onclick") === "showPage('about')") {
        animateProgressBar(75, 2000); // Set the desired percentage and duration here for the progress bar
        animateProgressBar2(50, 1500); 
        animateProgressBar3(80, 2500); 
        animateProgressBar4(60, 1200); 
